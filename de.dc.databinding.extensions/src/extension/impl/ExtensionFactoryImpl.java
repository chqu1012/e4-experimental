...
public class ExtensionFactoryImpl extends EFactoryImpl implements ExtensionFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ExtensionPackage.FORM_PART: return createFormPart();
			case ExtensionPackage.COMPOSITE: return createComposite();
			case ExtensionPackage.GRID_DATA: return createGridData();
			default:
	...
	public FormPart createFormPart() {
		FormPartImpl formPart = new FormPartImpl();
		return formPart;
	}
