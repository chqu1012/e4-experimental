...
public class ExtensionSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ExtensionPackage.FORM_PART: {
				FormPart formPart = (FormPart)theEObject;
				T result = caseFormPart(formPart);
				if (result == null) result = casePart(formPart);
				if (result == null) result = casePartSashContainerElement(formPart);
				if (result == null) result = caseStackElement(formPart);
				if (result == null) result = caseContribution(formPart);
				if (result == null) result = caseContext(formPart);
				if (result == null) result = caseUILabel(formPart);
				if (result == null) result = caseHandlerContainer(formPart);
				if (result == null) result = caseDirtyable(formPart);
				if (result == null) result = caseBindings(formPart);
				if (result == null) result = caseWindowElement(formPart);
				if (result == null) result = caseUIElement(formPart);
				if (result == null) result = caseApplicationElement(formPart);
				if (result == null) result = caseLocalizable(formPart);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ExtensionPackage.COMPOSITE: {
				Composite composite = (Composite)theEObject;
				T result = caseComposite(composite);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ExtensionPackage.LAYOUT_DATA: {
				LayoutData layoutData = (LayoutData)theEObject;
				T result = caseLayoutData(layoutData);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ExtensionPackage.GRID_DATA: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Form Part</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Form Part</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseFormPart(FormPart object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseUIElement(MUIElement object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T casePartSashContainerElement(MPartSashContainerElement object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T casePart(MPart object) {
		return null;
	}
